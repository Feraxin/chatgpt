...
with gr.Blocks(title='Talk to chatGPT') as demo:
    ...
    gr.HTML("<p> Instruction on how to get session token can be seen in video <a style='display:inline-block' href='https://www.youtube.com/watch?v=TdNSj_qgdFk'>here</a>. Add your session token by going to settings and add under secrets </p>")
